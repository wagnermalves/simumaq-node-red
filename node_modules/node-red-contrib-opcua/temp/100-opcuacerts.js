...
module.exports = function(RED) {
    ...
    function opcua-certs(n) {
        ...
        if ((certPath.length > 0) || (keyPath.length > 0)) {
            ...
            if ( (certPath.length > 0) !== (keyPath.length > 0)) {
                this.valid = false;
                this.error(RED._("opcua.error.missing-file"));
                return;
            }
    ...
    RED.nodes.registerType("opcua-certs", opcuaCerts, {
        credentials: {
            certdata: {type:"text"},
            keydata: {type:"text"},
            cadata: {type:"text"},
    ...
    opcuaConfig.prototype.addopcuaOptions = function(opts) {
        if (this.valid) {
            if (this.key) {
                opts.key = this.key;
            }
