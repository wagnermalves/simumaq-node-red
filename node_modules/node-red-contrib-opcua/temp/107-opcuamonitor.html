...
<script type="text/javascript">
    RED.nodes.registerType('OpcUa-Monitor', {
        category: 'opcua',
        color: "#3FADB5",
        defaults: {
        ...
        label: function () {
            return this.name || "OPC UA Monitor";
        },
        labelStyle: function () {
...
<script type="text/x-red" data-template-name="OpcUa-Monitor">
    <div class="form-row">
...
<script type="text/x-red" data-help-name="OpcUa-Monitor">
