 ...
 **/
 ...
 // For quick implementation and compatibility new node just for monitoring subscribed value
 // Additional parameters can be given for the deadband filter
...
module.exports = function (RED) {
  ...
  function OpcUaMonitorNode(n) {
    ...
    this.deadbandtype = n.deadbandtype;   // absolute or percent
    this.deadbandvalue = n.deadbandvalue; // value used in filter
        ...
        var  monitoredItemCreateRequest1 = new MonitoredItemCreateRequest({
          ...
          requestedParameters: {
            ...
            filter: new subscription_service.DataChangeFilter({
              ...
              deadbandType: subscription_service.DeadbandType.Percent, // TODO from UI n.deadbandtype
              deadbandValue: 10.0 /* 10% */ // TODO from UI n.deadbandvalue
           })
          }
        });
...
*/
  ...
  RED.nodes.registerType("OpcUa-Monitor", OpcUaMonitorNode);
};
